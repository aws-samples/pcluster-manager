...
![CloudFormation Outputs](docs/static/images/getting-started/pcmanager-url.png)

For more details see the [Getting Started Guide](https://pcluster-manager.github.io/).

## Screen Shot

![Main Page](docs/static/images/getting-started/main-page.png)

## System Architecture

![Pcluster Manager Architecture](docs/static/images/getting-started/architecture.png)
