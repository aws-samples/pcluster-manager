...
function clusters(state = {}, action: any) {
  return state
}
function customImages(state = {}, action: any) {
  return state
}
function officialImages(state = {}, action: any) {
  return state
}
function users(state = {}, action: any) {
  return state
}
function wizard(state = {}, action: any) {
  return state
}
function app(state = {}, action: any) {
  return state
}
...
function recurseAction(state: any, action: any) {
  ...
  const nested = rootReducer(subState, {
    type: action.type,
    payload: {...action.payload, path: path.slice(1)},
  })
...
function getState(state: any, path?: string[]) {
  ...
  if (path === undefined) return getState(store.getState(), state)
